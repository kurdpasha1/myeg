...
print("Preparing Keep-Alive System...")
os.system("clear")
...
def NUpdate(chk,hits,bdhits,bdhitlogBool):
    x = 0
    while x < 1:
        if hits.value >= 1:
            if bdhitlogBool == False:
                time.sleep(5)
                os.system("clear")
                print("V 1.3")
                print("\033[32mEquity WMiner - Cloud Project Beta v0.2 | ENGAGED \033[0m")
                print("")
                print("\033[32mStarting mining processess..\033[0m \n")
                print("\n\033[31m> ..MINING IN PROGRESS.. <\033[0m")
                print("\033[31mERRS %s | \033[32mHITS: %s\033[31m | BDHITS: %s\033[0m"%(chk.value, hits.value, bdhits.value))
            else:
                time.sleep(30)
                print("\033[31m-----------------------------------------------------------------------------------------------------")
                print("\033[31m                              GOT AN HIT! - Miner Resume - GOT AN HIT!                             ")
                print("\033[31m                                   ERRS %s | \033[32mHITS: %s\033[31m | BDHITS: %s                 "%(chk.value, hits.value, bdhits.value))
            ...
            if bdhitlogBool == False:
              ...
              print("\033[32mStarting mining processess..\033[0m \n")
              print("\n\033[31m> ..MINING IN PROGRESS.. <\033[0m")
              print("\033[31mERRS %s | HITS: %s | BDHITS: %s\033[0m"%(chk.value, hits.value, bdhits.value))
            else:
              time.sleep(30)
              print("\033[31m-----------------------------------------------------------------------------------------------------")
              print("\033[31m                                           Miner Resume                                             ")
              print("\033[31m                                   ERRS %s | HITS: %s | BDHITS: %s                                 "%(chk.value, hits.value, bdhits.value))
              print("\033[31m-----------------------------------------------------------------------------------------------------\033[0m")
        time.sleep(0.02)
...
if __name__=="__main__":
    ...
    @app.route('/')
    def home():
        return "Keep Alive Process Has Been Initialized. You can close this window now."
    ...
    print("Initialazing Keep-Alive System...")
    keep_alive()
    print("Initializing Keep-Alive System...")
    os.system("clear")
    ##End of Keep Alive Function
    try:
        multiprocessing.freeze_support()
        os.system("clear")
        print("V 1.32")
        print("Equity WMiner - Cloud Project Beta v0.2")
        print("\n \033[33m# Ensure you are running this script in a fork, otherwise your hits will be visible to everyone!\033[0m")
            ...
            if int(intensity) >= 1 and int(intensity) <= 100:
                ...
                if w3.isConnected():
                    ...
                    if __name__=="__main__":
                        ...
                        updP = multiprocessing.Process(target=NUpdate, args=(chk,hits,bdhits,badhitbool,))
                        updP.start()
